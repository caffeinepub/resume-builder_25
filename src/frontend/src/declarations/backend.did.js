...
export const ResumeTemplate = IDL.Variant({
  'minimal' : IDL.Null,
  'classic' : IDL.Null,
  'modern' : IDL.Null,
});
...
export const idlService = IDL.Service({
  ...
  'reclaimAdmin' : IDL.Func([IDL.Text], [], []),
  ...
  'updateResume' : IDL.Func([IDL.Nat, Resume], [], []),
});
...
export const idlFactory = ({ IDL }) => {
  ...
  const ResumeTemplate = IDL.Variant({
    'minimal' : IDL.Null,
    'classic' : IDL.Null,
    'modern' : IDL.Null,
  });
